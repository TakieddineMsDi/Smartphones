...
<%
	Administrateurs admin = (Administrateurs) request.getSession()
...
<body>
			...
			<div class="navbar-inner">
				<div class="container-fluid">
					<a class="btn btn-navbar" data-toggle="collapse"
						...
						class="icon-bar"></span>
					</a> <a class="brand" href="index.html"> <span>smartphones</span></a>
					...
					<div class="row-fluid sortable">
						<div class="box span12">
							<div class="box-header well" data-original-title>
								...
								<div class="box-icon">
									<a class="btn" href="#" onclick='javascript:dorefresh()'><i
										class="icon-refresh"></i></a> <a href="AdminPanel.Do?addclient=1"
										class="btn btn-round"><i class="icon-plus"></i></a> <a
							...
							<div class="box-content">
								<table
									...
									<tbody id="ajaxresult" name="ajaxresult">
										<core:set var="clients"
											value="<%=admin.get(\"clients\", \"\", \"\", \"\", \"\",\"DateInscription\",\"DESC\",\"\",\"List\")%>"></core:set>
										<core:if test="${clients!=null&&!clients.get(0).isEmpty() }">
											<core:forEach var="client" items="${clients }">
												<tr id="${client.getID()}" name="${client.getID()}">
													<td style="visibility: collapse; display: none;">${client.getID()}</td>
													<td>${client.getUsername() }</td>
													<td class="center">${client.getEmail() }</td>
													<td class="center">${client.getRCountry().getLibelle()}</td>
													<td class="center">${client.getDateInscription() }</td>
													<core:if test="${client.isAllowedToSubmit() }">
														<td class="center"><span class="label label-success">Allowed</span>
														</td>
													</core:if>
													<core:if test="${!client.isAllowedToSubmit() }">
														<td class="center"><span
															class="label label-important">Not Allowed</span></td>
													</core:if>
													<core:if test="${client.isActif() }">
														<td class="center"><span class="label label-success">Active</span>
														</td>
													</core:if>
													<core:if test="${client.isArchive() }">
														<td class="center"><span class="label label-info">Archived</span>
														</td>
													</core:if>
													<core:if test="${client.isBanned() }">
														<td class="center"><span
															class="label label-important">Banned</span></td>
													</core:if>
													<core:if test="${client.isInactif() }">
													...
													<td class="center">
														<div class="btn-group">
															...
															<ul class="dropdown-menu">
																<li><a
																	href="AdminPanel.Do?editclient=${client.getID() }"><i
																		class="icon-pencil"></i> Edit</a></li>
																<li><a href="#"
																	onclick='javascript:dothis("deleteclient","${client.getID() }")'><i
																		class="icon-trash"></i> Delete</a></li>

																<core:if test="${client.isInactif() }">
																	<li><a href="#"
																		onclick='javascript:dothis("activeclient","${client.getID() }")'><i
																			class="icon-ok"></i> Activate</a></li>
																</core:if>
																<core:if test="${client.isArchive() }">
																	<li><a href="#"
																		onclick='javascript:dothis("restoreclient","${client.getID() }")'><i
																			class="icon-flag"></i> Restore</a></li>
																</core:if>
																<core:if test="${!client.isArchive() }">
																	<li><a href="#"
																		onclick='javascript:dothis("archiveclient","${client.getID() }")'><i
																			class="icon-book"></i> Archive</a></li>
																</core:if>
																<core:if test="${client.isBanned() }">
																	<li><a href="#"
																		onclick='javascript:dothis("unbanclient","${client.getID() }")'><i
																			class="icon-ok-circle"></i> UnBan</a></li>
																</core:if>
																<core:if test="${!client.isBanned() }">
																	<li><a href="#"
																		onclick='javascript:dothis("banclient","${client.getID() }")'><i
																			class="icon-ban-circle"></i> Ban</a></li>
																</core:if>
																<core:if test="${!client.isAllowedToSubmit() }">
																	<li><a href="#"
																		onclick='javascript:dothis("allowsubmitclient","${client.getID() }")'><i
																			class="icon-check"></i> Allow Submit</a></li>
																</core:if>
																<core:if test="${client.isAllowedToSubmit() }">
																	<li><a href="#"
																		onclick='javascript:dothis("bansubmitclient","${client.getID() }")'><i
																			class="icon-remove-circle"></i> Ban Submit</a></li>
																</core:if>
															</ul>
														</div>
													</td>
	...
	<script type="text/javascript">
		...
		function update(action, id) {
			...
			self.xmlHttpReq.send("action=" + action + "," + id);
		}
