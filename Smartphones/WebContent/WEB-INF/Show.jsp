...
<jsp:useBean id="Client" class="Isamm.ing.java.Smartphones.Models.Clients">
</jsp:useBean>
<%
...
<body>
				...
				<core:if test="<%=LoggedIn == true%>">
					...
					<core:if test="<%=Client.hasProducts()%>">
						<div class="btn-group pull-right">
							...
							<ul class="dropdown-menu">
								<li><a href="#" class="btn-setting" 
								onclick='javascript:doaction("viewprod")'>View Products</a></li>
								<li><a href="#" class="btn-setting"
									onclick='javascript:doaction("addprod")'>Add a product</a></li>
								<li class="divider"></li>
							</ul>
	...
	<!-- Show All stats -->
	<core:if test="<%=request.getParameter(\"Mine\")!=null %>">
				<div class="row-fluid">
				<div class="box span12">
					<div class="box-header well">
						<h2><i class="icon-info-sign"></i> My Products</h2>
						<div class="box-icon">
				...
				<div class="box span12">
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <core:set var="produits" value="<%=Client.getProduits() %>"></core:set>
